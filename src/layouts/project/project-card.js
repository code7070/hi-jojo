export default function ProjectCard({
  ...
  const noFirstClass = isFirst ? "" : "md:-mt-64";
  return (
    <div
      className={`relative rounded-2xl border-b-8 border-4 border-secondary w-[100%] max-w-xs overflow-hidden ${evenClass} ${noFirstClass} my-6 transition-all duration-300 cursor-pointer hover:border-primary`}
    >
