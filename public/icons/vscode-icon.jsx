...
function VscodeIcon() {
  return (
    ...
    >
      ...
      <path
        fill="#000"
        d="M4.116 11.937L.228 15.509s-.4.3 0 .837l1.805 1.66s.429.465 1.062-.065l4.121-3.158-3.1-2.846zM10.94 11.966l7.13-5.502-.047-5.505s-.305-1.202-1.32-.576L7.216 9.11l3.724 2.856z"
      ></path>
      <path
        fill="#000"
